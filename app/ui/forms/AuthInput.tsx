...
export default function AuthInput({
  ...
  return (
    <section className='flex w-full flex-col gap-2.5'>
      <label htmlFor={name} className='select-none font-medium text-zinc-400'>
        {label}
      </label>
      <section className='flex w-full items-center overflow-hidden rounded-lg bg-zinc-50'>
        <input
          ...
          className='h-10 flex-grow bg-zinc-50 px-2.5 text-zinc-950 filter-none placeholder:text-zinc-400 focus:outline-none'
        />
        {type === 'password' && (
          <button
            type='button'
